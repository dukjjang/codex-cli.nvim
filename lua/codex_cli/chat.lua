...
local function highlights()
	...
	api.nvim_set_hl(0, "CodexGlass", { fg = "#e8e8e4", bg = "#141414" })
	api.nvim_set_hl(0, "CodexBorder", { fg = "#41413d", bg = "#141414" })
	api.nvim_set_hl(0, "CodexInputBorder", { fg = "#41413d", bg = "#101010" })
	api.nvim_set_hl(0, "CodexInput", { fg = "#f0f0ec", bg = "#101010" })
	api.nvim_set_hl(0, "CodexAccent", { fg = "#d4d4ce", bold = true })
	api.nvim_set_hl(0, "CodexLabel", { fg = "#a5a5a0", bg = "#141414" })
	api.nvim_set_hl(0, "CodexInputLabel", { fg = "#a5a5a0", bg = "#101010" })
